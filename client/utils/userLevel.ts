...
// Interface utilisée par le composant UserLevelBadge
export interface UserLevel {
  level: number;        // Numéro du niveau (1-10)
  title: string;        // Titre du niveau
  color: string;        // Couleur associée au niveau
  progress: number;     // Progression vers le niveau suivant (0-100%)
  currentPoints: number; // Points actuels
  nextLevelPoints: number; // Points requis pour le niveau suivant
}
